        ...
        <div class="row g-0 d-flex flex-column justify-content-between align-items-center gap-4">
            ...
            <div class="row">
                ...
                <div class="col-12 input-group input-group-lg p-0">
                    <form:input path="userEmail" type="email" name="userEmail" class="form-control" />
            ...
            <div class="row gap-0">
                ...
                <div class="col-12 d-flex">
                    ...
                    <button type="button" id="generalTermDetail" class="termDetail btn btn-sm ms-auto text-secondary p-0">자세히</button>
                </div>
                ...
                <div class="col-12 d-flex">
                    ...
                    <button type="button" id="privacyTermDetail" class="termDetail btn btn-sm ms-auto text-secondary p-0">자세히</button>
                </div>
                <form:errors path="privacyTermAgreement" cssClass="col-12 text-danger p-0 ps-3" />
                <div class="col-12 d-flex">
                    <form:checkbox path="emailSubscriptionAgreement"  id="emailSubscriptionAgreement" name="emailSubscriptionAgreement" />
