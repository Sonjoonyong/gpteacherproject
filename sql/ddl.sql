...
(
    ...
    community_post_writedate TIMESTAMP DEFAULT SYSDATE NULL,
...
COMMENT
ON COLUMN learning.learning_type IS 'WRITING, SPEAKING, DIALOGUE';

COMMENT
ON COLUMN learning.learning_test_name IS 'TOEIC, TOEFL, IELTS, OPIC';
...
COMMENT
ON COLUMN board_question.question_status IS 'N=답변중,Y=완료';
...
(
    ...
    question_reply_writedate TIMESTAMP DEFAULT SYSDATE NULL,
...
(
    id                          NUMBER NOT NULL,
    user_id                     NUMBER NOT NULL,
    reported_community_post__id NUMBER NULL,
    reported_reply_id           NUMBER NULL,
